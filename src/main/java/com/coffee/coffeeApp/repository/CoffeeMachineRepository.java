...
public interface CoffeeMachineRepository extends JpaRepository<CoffeeMachine, String> {
    ...
    Long countByFacilityIdAndIsActiveTrue(String facilityId);
    ...
    Long countOperationalMachinesByFacility(@Param("facilityId") String facilityId);
    ...
    void updateMachineLevels(@Param("machineId") String machineId, 
